...
- **[Baseconv](https://github.com/KerHack-Libre/baseconv)** - Converts to different numerical bases such as binary (2), octal (8) and hexadecimal (16) and more... with built-in interactive shell. - **[@KerHack-Libre](https://github.com/KerHack-Libre)**
...
- **[Demo Spring Boot Keycloak Maildev](https://github.com/bayembacke221/demo-springboot-keycloak-auth-crud)** - This project is a sample Spring Boot application integrating Keycloak for authentication, user registration, sending email withe Maildev, and CRUD operations. - **[@bayembacke221](https://github.com/bayembacke221)**
...
- **[FileGenius](https://github.com/sibylassana95/FileGenius)** - Smart file organizer, fully local via Ollama. Analyzes the actual contents of your files—images, documents and automatically sorts them into named, structured subfolders. - **[@sibylassana95](https://github.com/sibylassana95)**
...
- **[JammBox](https://github.com/KerHack-Libre/JammBox)** - A collection of classic DOS games, already configured to work easily with DOSBox, via a lightweight user interface (TUI). - **[@KerHack-Libre](https://github.com/KerHack-Libre)**
...
- **[Sen Decoupage](https://github.com/TheShvdow/decoupage_administratif_api)** - A public REST API providing Senegal's administrative divisions with GPS coordinates, altitude, and region codes. - **[@TheShvdow](https://github.com/TheShvdow)**
